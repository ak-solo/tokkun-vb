...
![Dog オブジェクト：データ（name/age/breed）と操作（Speak/ShowProfile）をひとまとめにする](images/ch07-object.svg)
...
![クラス（設計図）から New で複数のインスタンス（pochi・koro）を作れる](images/ch07-class-instance.svg)
